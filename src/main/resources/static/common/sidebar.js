document.write("<div class=\"col-sm-3 col-xs-6 sidebar pl-0\">"+
               ...
               "                     <li class=\"child\"><a href=\"/user/home\" class=\"ml-4\"><i class=\"fa fa-angle-right mr-2\"></i> Default</a></li>"+
			...
			"						<li class=\"child\"><a href=\"/user/apply-leave\" class=\"ml-4\"><i class=\"fa fa-angle-right mr-2\"></i> Apply Leave</a></li>"+
			"						<li class=\"child\"  class=\"parent\" sec:authorize=\"hasAuthority('0')\"><a href=\"/user/manage-leaves\" class=\"ml-4\"><i class=\"fa fa-angle-right mr-2\"></i> Manage Leave</a></li>"+
			"						<li class=\"child\"><a href=\"/user/my-leaves\" class=\"ml-4\"><i class=\"fa fa-angle-right mr-2\"></i> My Leave</a></li>"+
			"					</ul>"+
			"				</li>"+
			"				<li class=\"parent\">"+
             "                   <a href=\"fullcalendar.html\" class=\"\"><i class=\"fa fa-calendar-o mr-3\"> </i>"+
              "                      <span class=\"none\"> Full Calendar </span>"+
               "                 </a>"+
                "            </li>"+
                 "           <li class=\"parent\">"+
                  "              <a  href=\"/user/change-password\" class=\"\"><i class=\"fa fa-key\"> </i>"+
